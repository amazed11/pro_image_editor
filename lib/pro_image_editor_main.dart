  ...
  void closeWarning() async {
    ...
    await showAdaptiveDialog(
      ...
      builder: (BuildContext context) => AdaptiveDialog(
        ...
        title: Text(
          widget.configs.i18n.various.closeEditorWarningTitle,
        ...
        content: Text(
          widget.configs.i18n.various.closeEditorWarningMessage,
          textAlign: TextAlign.center,
          style: const TextStyle(
            fontSize: 16,
        ...
        actions: <AdaptiveDialogAction>[
          AdaptiveDialogAction(
            ...
            child: Text(
              widget.configs.i18n.various.closeEditorWarningCancelBtn,
              style: const TextStyle(color: Color(0xffD3180C)),
            ),
          ),
          AdaptiveDialogAction(
            designMode: widget.configs.designMode,
